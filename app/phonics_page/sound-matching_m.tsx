...
const mQuestions = [
  {
    ...
    correctAnswers: [{ label: "Mango", image: require("../../assets/images/mango.jpg") }],
    options: [
  ...
  },
  {
    letter: "M",
    sound: require("../../assets/sound/m.m4a"),
    correctAnswers: [{ label: "Monkey", image: require("../../assets/images/monkey.jpg") }],
    options: [
  ...
  },
  {
    letter: "M",
    sound: require("../../assets/sound/m.m4a"),
    correctAnswers: [{ label: "Moon", image: require("../../assets/images/moon.jpg") }],
    options: [
