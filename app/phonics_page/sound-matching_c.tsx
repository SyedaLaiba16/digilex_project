// app/phonics_page/SoundMatchingGameC.tsx
...
const cQuestions = [
  {
    ...
    correctAnswers: [{ label: "Cat", image: require("../../assets/images/cat.png") }],
    options: [
  ...
  },
  {
    letter: "C",
    sound: require("../../assets/sound/c.m4a"),
    correctAnswers: [{ label: "Car", image: require("../../assets/images/car.png") }],
    options: [
  ...
  },
  {
    letter: "C",
    sound: require("../../assets/sound/c.m4a"),
    correctAnswers: [{ label: "Cup", image: require("../../assets/images/cup.jpg") }],
    options: [
...
export default function SoundMatchingGameC() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(cQuestions).map((q) => ({
      ...q,
  ...
  const handleOptionPress = (selectedLabel: string) => {
    ...
    if (isCorrect) {
      if (questionIndex + 1 < questions.length) {
        ...
        Alert.alert("🎉 Great job!", "", [{ text: "OK", onPress: () => router.push("/phonics_page/level2") }]);
      }
    } else {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter C</Text>
