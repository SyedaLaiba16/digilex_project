...
const zQuestions = [
  {
    ...
    correctAnswers: [{ label: "Zebra", image: require("../../assets/images/zebra.jpg") }],
    options: [
  ...
  },
  {
    letter: "Z",
    sound: require("../../assets/sound/z.m4a"),
    correctAnswers: [{ label: "Zip", image: require("../../assets/images/zip.jpg") }],
    options: [
  ...
  },
  {
    letter: "Z",
    sound: require("../../assets/sound/z.m4a"),
    correctAnswers: [{ label: "Zoo", image: require("../../assets/images/zoo.jpg") }],
    options: [
      { label: "Zoo", image: require("../../assets/images/zoo.jpg") },
...
export default function SoundMatchingGameZ() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(zQuestions).map((q) => ({
      ...q,
      ...
      if (triesLeft > 1) {
        ...
        if (questionIndex + 1 < questions.length) {
          ...
          Alert.alert("Out of tries!", "Let's move back.", [
            { text: "OK", onPress: () => router.push("/phonics_page/level3") },
          ]);
        }
      }
    }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter Z</Text>
