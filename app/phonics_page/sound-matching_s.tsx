// app/phonics_page/sound-matching.tsx
...
// All questions for letter S (multiple correct answers supported)
const sQuestions = [
  {
    letter: "S",
    sound: require("../../assets/sound/s.m4a"),
    correctAnswers: [
      { label: "Sand", image: require("../../assets/images/sand.png") },
    ],
    options: [
      { label: "Sand", image: require("../../assets/images/sand.png") },
  ...
  },
  {
    ...
    sound: require("../../assets/sound/s.m4a"),
    correctAnswers: [
      { label: "Sock", image: require("../../assets/images/socks.png") }
    ],
    options: [
      { label: "Sock", image: require("../../assets/images/socks.png") },
