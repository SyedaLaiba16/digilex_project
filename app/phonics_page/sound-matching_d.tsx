...
// All questions for letter D
const dQuestions = [
  {
    letter: "D",
    sound: require("../../assets/sound/d.m4a"), // 👈 Make sure this file exists
    correctAnswers: [
  ...
  },
  {
    ...
    sound: require("../../assets/sound/d.m4a"),
    correctAnswers: [
      { label: "Drum", image: require("../../assets/images/drum.jpg") },
    ],
    options: [
      { label: "Drum", image: require("../../assets/images/drum.jpg") },
  ...
  },
  {
    ...
    sound: require("../../assets/sound/d.m4a"),
    correctAnswers: [
      { label: "Door", image: require("../../assets/images/door.jpg") },
    ],
    options: [
      { label: "Door", image: require("../../assets/images/door.jpg") },
...
export default function SoundMatchingGameD() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(dQuestions).map(q => ({
      ...q,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter D</Text>
