...
// All questions for letter I
const iQuestions = [
  {
    letter: "I",
    sound: require("../../assets/sound/i.m4a"), // 👈 Make sure this file exists
    correctAnswers: [
  ...
  },
  {
    ...
    correctAnswers: [
      { label: "Ink", image: require("../../assets/images/ink.png") },
    ],
    options: [
      { label: "Ink", image: require("../../assets/images/ink.png") },
  ...
  },
  {
    ...
    sound: require("../../assets/sound/i.m4a"),
    correctAnswers: [
      { label: "Ice", image: require("../../assets/images/ice.png") },
    ],
    options: [
      { label: "Ice", image: require("../../assets/images/ice.png") },
...
export default function SoundMatchingGameI() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(iQuestions).map(q => ({
      ...q,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter I</Text>
