...
const pQuestions = [
  {
    ...
    correctAnswers: [{ label: "Pen", image: require("../../assets/images/pen.png") }],
    options: [
  ...
  },
  {
    letter: "P",
    sound: require("../../assets/sound/p.m4a"),
    correctAnswers: [{ label: "Pin", image: require("../../assets/images/pin.png") }],
    options: [
  ...
  },
  {
    letter: "P",
    sound: require("../../assets/sound/p.m4a"),
    correctAnswers: [{ label: "Parrot", image: require("../../assets/images/parrot.jpg") }],
    options: [
      { label: "Parrot", image: require("../../assets/images/parrot.jpg") },
...
export default function SoundMatchingGameP() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(pQuestions).map((q) => ({
      ...q,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter P</Text>
