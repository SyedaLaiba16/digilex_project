// app/phonics_page/SoundMatchingGameB.tsx
...
const bQuestions = [
  {
    ...
    correctAnswers: [{ label: "Ball", image: require("../../assets/images/ball.jpg") }],
    options: [
  ...
  },
  {
    letter: "B",
    sound: require("../../assets/sound/b.m4a"),
    correctAnswers: [{ label: "Bat", image: require("../../assets/images/bat.png") }],
    options: [
      { label: "Bat", image: require("../../assets/images/bat.png") },
      { label: "Dog", image: require("../../assets/images/dog.png") },
      { label: "Cup", image: require("../../assets/images/cup.jpg") },
    ],
  },
  {
    letter: "B",
    sound: require("../../assets/sound/b.m4a"),
    correctAnswers: [{ label: "Bag", image: require("../../assets/images/bag.jpg") }],
    options: [
      { label: "Bag", image: require("../../assets/images/bag.jpg") },
...
export default function SoundMatchingGameB() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(bQuestions).map((q) => ({
      ...q,
      ...
      if (triesLeft > 1) {
        ...
        if (questionIndex + 1 < questions.length) {
          ...
          Alert.alert("Out of tries!", "Let's move back.", [
            { text: "OK", onPress: () => router.push("/phonics_page/level2") },
          ]);
        }
      }
    }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter B</Text>
