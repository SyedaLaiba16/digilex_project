// app/phonics_page/sound-matching-a.tsx
...
// All questions for letter A
const aQuestions = [
  {
    letter: "A",
    sound: require("../../assets/sound/a.m4a"), // 👈 Make sure this file exists
    correctAnswers: [
  ...
  },
  {
    ...
    sound: require("../../assets/sound/a.m4a"),
    correctAnswers: [
      { label: "Axe", image: require("../../assets/images/axe.jpg") },
    ],
    options: [
      { label: "Axe", image: require("../../assets/images/axe.jpg") },
  ...
  },
  {
    ...
    sound: require("../../assets/sound/a.m4a"),
    correctAnswers: [
      { label: "Arrow", image: require("../../assets/images/arrow.jpg") },
    ],
    options: [
      { label: "Arrow", image: require("../../assets/images/arrow.jpg") },
...
export default function SoundMatchingGameA() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(aQuestions).map(q => ({
      ...q,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter A</Text>
