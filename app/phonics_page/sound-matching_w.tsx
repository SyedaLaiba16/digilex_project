...
const wQuestions = [
  {
    ...
    correctAnswers: [{ label: "Watch", image: require("../../assets/images/watch.png") }],
    options: [
  ...
  },
  {
    letter: "W",
    sound: require("../../assets/sound/w.m4a"),
    correctAnswers: [{ label: "Window", image: require("../../assets/images/window.jpg") }],
    options: [
  ...
  },
  {
    letter: "W",
    sound: require("../../assets/sound/w.m4a"),
    correctAnswers: [{ label: "Water", image: require("../../assets/images/water.jpg") }],
    options: [
      { label: "Water", image: require("../../assets/images/water.jpg") },
...
export default function SoundMatchingGameW() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(wQuestions).map((q) => ({
      ...q,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter W</Text>
