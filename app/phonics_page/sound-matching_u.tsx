// app/phonics_page/SoundMatchingGameU.tsx
...
const uQuestions = [
  {
    ...
    correctAnswers: [{ label: "Umbrella", image: require("../../assets/images/umbrella.jpg") }],
    options: [
  ...
  },
  {
    letter: "U",
    sound: require("../../assets/sound/u.m4a"),
    correctAnswers: [{ label: "Up", image: require("../../assets/images/up.jpg") }],
    options: [
  ...
  },
  {
    letter: "U",
    sound: require("../../assets/sound/u.m4a"),
    correctAnswers: [{ label: "Uncle", image: require("../../assets/images/uncle.jpg") }],
    options: [
      { label: "Uncle", image: require("../../assets/images/uncle.jpg") },
...
export default function SoundMatchingGameU() {
  ...
  useEffect(() => {
    const randomized = shuffleArray(uQuestions).map((q) => ({
      ...q,
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Sound Matching - Letter U</Text>
